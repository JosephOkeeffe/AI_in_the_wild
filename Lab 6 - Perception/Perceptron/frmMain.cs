...
namespace Perceptron
{
    public partial class frmMain : Form
    {
        ...
        private void btnLearn_Click(object sender, EventArgs e)
        {
            ...
            {
                double input = w1 * sample.X1 + w2 * sample.X2 + w0 * x0;
                ...
                int actualValue = (int)sample.Class;
                int errorValue = actualValue - predictedValue;

                if (errorValue != 0)
                {
                    w1 += eta * errorValue * sample.X1;
                    w2 += eta * errorValue * sample.X2;
                    w0 += eta * errorValue * x0;
                }
            }
            // {
